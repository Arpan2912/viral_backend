...
module.exports = {
  ...
  getPersons: `select u_uuid as uuid,first_name,last_name,address,designation,phone,email from persons`,
  getRoughList: `select u_uuid as rough_id,lot_name,rough_name,weight,price,unit from roughs`,
